...
def insert_sample_data(conn):
    ...
    transactions_data = [
        ('C001', 1, 'V001', 'K001', 1, 15.00, '2024-01-01 08:00'),
        ('C002', 2, 'V002', 'K002', 2, 20.94, '2024-01-01 08:15'),
        ('C003', 3, 'V003', 'K003', 3, 25.34, '2024-01-01 08:30'),
        ('C004', 4, 'V004', 'K004', 4, 29.08, '2024-01-01 08:45'),
        ('C005', 5, 'V005', 'K005', 5, 29.52, '2024-01-01 09:00'),
    ]
    
    cursor.executemany(
        """INSERT INTO transactions
        (commuter_id, route_id, vehicle_id, conductor_id, fare_id, total_fare, transaction_date)
        VALUES (?, ?, ?, ?, ?, ?, ?)""",
        transactions_data
    )
