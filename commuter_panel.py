...
from routes_fares import FareCalculatorApp  # Adjust this import as needed
...
class CommuterPanel(QWidget):
    ...
    def __init__(self, db_manager, user_data):
        ...
        # Set fixed window size to 75% of the screen
        screen = QApplication.primaryScreen().availableGeometry()
        width = int(screen.width() * 0.75)
        height = int(screen.height() * 0.75)
        self.setFixedSize(width, height)

        self.routes_fares_window = None  # for button
    ...
    def init_ui(self):
        ...
        image_path = image_path.replace("\\", "/")  # Convert to forward slashes for stylesheet
        ...
        # View Routes and Fares Button (centered)
        ...
        # Uniform stretch for all columns
            ...
            if routes:
                for i, route in enumerate(routes):
                    ...
                    if current_preferred_route == route_id:
                        selected_index = i + 1  # +1 for the "Select Preferred Route" item
            self.preferred_route_combo.setCurrentIndex(selected_index)
    
            # Populate driver/conductor combos for feedback
    ...
    def update_commuter_info(self):
        try:
            ...
            # Update users table - REMOVE EXTRA COMMA
            users_success = self.db_manager.execute_insert_update_delete(
                ...
                (self.first_name_input.text().strip(),
                 ...
                 user_id),  # NO COMMA HERE
                commit=False
            )
            
            # Get preferred_route with type safety
            ...
            # Update commuters table - REMOVE EXTRA COMMA
